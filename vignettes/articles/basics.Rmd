...
The objective here is to provide a more structured code than provided in the supplement, relying fully on tidyverse lingo, including usage of the {purrr} map-function family, where possible rather than loops. The details are though hidden within the function-calls, the output only providing the essence needed for vessel track behavioural postprocessing analysis.
