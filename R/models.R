...
#' @export
#'
rb_gaussian <- function(d, cs = 1.96, minimal = TRUE) {
  d <- 
    d %>%
...
#' @export
#'
rb_gaussian_binary_clustering <- function(d, cs = 1.96, minimal = TRUE) {
  d <- 
    d %>%
...
#' @export
#'
rb_hidden_markov_step <- function(d, minimal = TRUE) {
...
#' @export
#'
rb_hidden_markov_step_and_turn <- function(d, minimal = TRUE) {
